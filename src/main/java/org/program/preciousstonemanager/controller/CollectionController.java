...
public class CollectionController extends SceneWithTablesController {
    @Override
    ...
    public void switchToSortStones(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/org/program/preciousstonemanager/SortStonesCollectionScene.fxml")));
        loader.load();
